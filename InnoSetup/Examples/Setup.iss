...
;
; $jrsoftware: ispack/setup.iss,v 1.86 2010/02/18 15:38:02 mlaan Exp $

[Setup]
AppName=Inno Setup QuickStart Pack
AppId=Inno Setup 5
AppVerName={cm:NameAndVersion,Inno Setup QuickStart Pack,5.3.8}
AppVersion=5.3.8
...
Name: "{commondesktop}\Inno Setup Compiler"; Filename: "{app}\Compil32.exe"; WorkingDir: "{app}"; Tasks: desktopicon; Check: not ISToolCheck
